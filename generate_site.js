...
const pages = [
    {
        ...
        content: `
            ...
            <section class="section">
                <div class="container">
                    <h2>Why Choose Us?</h2>
                    <ul class="check-list" style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-top: 2rem;">
                        <li><strong>Local Expertise:</strong> Located in Moncton, serving all of NB.</li>
                        <li><strong>Proactive Advice:</strong> We contact you before deadlines.</li>
                        <li><strong>Technology Driven:</strong> We support Cloud Accounting (QuickBooks/Xero).</li>
    ...
    // Core Pages
    {
        ...
        content: `
            ...
            <section class="section"><div class="container"><p>Serving Greater Moncton since 2009.</p></div></section>
        `
    },
    {
