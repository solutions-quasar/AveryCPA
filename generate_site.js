                ...
                <div class="container">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
                        ...
                        <div style="position: relative;">
                            ...
                            <img src="/assets/images/joe_avery.jpg" alt="Joe Avery, Principal CPA" style="width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                        </div>
                    </div>
                </div>
            </section>
